...
def chat_request(questionJson):
    ...
    client = OpenAI(base_url="http://aiagent-pre.chengwen.net/api/v1", api_key="prechengwenai-boCYrN7FTTbu7hEZVnTmvAp3pGrZqsYimCTUmnBZaipY5nH3G67LqJJs8dCJi")
...
if __name__ == '__main__':
    ...
    with open('防晒衣_search_solved_copywriter_filtered.json','r', encoding='utf-8') as f:
        tasks = json.load(f)
    ...
    with open('防晒衣_search_solved_copywriter.json', 'w', encoding='utf-8') as f:
