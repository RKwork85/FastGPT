...
def chat_request(question_json):
    ...
    question = question_json['文案']
    # 在函数内部创建client实例
    client = OpenAI(
       base_url="http://aiagent-pre.chengwen.net/api/v1",  
       api_key="prechengwenai-pQLbBoNxZ0SSfuwxddD0952XUaoqtGdUVW8VLhdjF62mfOfpkHcfmV"
    )
    ...
    try:  
        ...
        print('返回结果',content)
        data_result = {'ID':question_json['ID'],'文案ID':question_json['文案ID'],'文案':f'{content}'}
        return data_result
...
with open('ID7.json','r', encoding='utf-8') as f:
...
with open('ID7_jianji.json', 'w', encoding='utf-8') as f:
