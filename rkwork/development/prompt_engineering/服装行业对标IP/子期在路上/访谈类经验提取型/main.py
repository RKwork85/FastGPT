...
client = OpenAI(
   ...
   api_key="prechengwenai-dPC3ZGs3tH7QRGEG9oAryZiGvs5wtDsPUQKoO0cMP6yvRF3mGBn9aTwjLSOd21"         ## 1 地址要对
)
...
tasks = [(client, question_data) for _ in range(2)]
...
result_number = chat_request(client=client, question=question_data)
