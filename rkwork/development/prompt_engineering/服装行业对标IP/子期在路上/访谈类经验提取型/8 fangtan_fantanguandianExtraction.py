...
def chat_request(question_json):
    ...
    client = OpenAI(
       ...
       api_key="prechengwenai-mtMLqiKbjFyKxdiAIwuhcuzwXohmyPl39JnvkcDxNjPn2qx7bvM6mT33esRH5"
    )
    ...
    try:  
        ...
        print('返回结果',content)
        data_result = {'视频ID':question_json['视频ID'],'访谈型文案观点参考提取助手':f'{content}'}
        return data_result
...
with open('访谈型文案观点参考提取助手.json', 'w', encoding='utf-8') as f:
