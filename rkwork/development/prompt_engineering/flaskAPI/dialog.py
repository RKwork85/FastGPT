...
def chat_request(questionJson):
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {'role': 'user', 'content': f'{questionJson}'}],
        stream= True
        )
    data_chunk = ''
...
if __name__ == '__main__':
    ...
    with open('/home/rkwork/rkwork/project/FastGPT/rkwork/development/prompt_engineering/flaskAPI/内衣_search_solved.json', 'w', encoding='utf-8') as f:
