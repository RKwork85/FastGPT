...
os.environ['DASHSCOPE_API_KEY'] = 'sk-be8fb3e390b84edba24374f7205a25c6'
...
question_message = '随机生成一句话'

# data =    {
#     "测试文本提示词": "construction3",
#     "阿里": "3",
#     "智谱": "3",
#     "扣子": "3"
# },
...
with ThreadPoolExecutor(max_workers=10) as executor:
    # 提交任务到线程池
    futures = [executor.submit(chat_request, client=client, question=i) for i in question_data]
