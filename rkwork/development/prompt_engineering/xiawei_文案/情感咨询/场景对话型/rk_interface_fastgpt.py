...
client = OpenAI(base_url="http://aiagent-pre.chengwen.net/api/v1", api_key="fastgpt-lnkSGrQ0q9JwXjyZbylAAVGSRsbh6nzL74Yas2fPghDDkiK1PVzDKMVhE7mEvqfJ")         # 需要在onepai平台中 添加渠道生成令牌
messages = []
user_message = {'role': 'user', 'content': '场景：学习时间管理'}
...
with open('daiding1.json', 'w', encoding='utf-8') as f:
