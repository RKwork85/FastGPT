...
def chat_request(question_json):
    ...
    client = OpenAI(
       ...
       api_key="prechengwenai-uGGkGpMMMqbtv9oMD5AToBFT9XTepqWKSRHCkZW7R1wOc3FtyHR9IPaheA4XR19"
    )
    ...
    try:  
        ...
        print('返回结果',content)
        data_result = {'视频ID':question_json['视频ID'],'访谈型视频文案脚本复现助手':f'{content}'}
        return data_result
...
with open('访谈型视频文案脚本复现助手.json', 'w', encoding='utf-8') as f:
